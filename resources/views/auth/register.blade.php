            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-xl border border-pink-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <!-- First Name -->
                        <div>
                            <x-input-label for="first_name" :value="__('First Name')" class="text-neutral-700 font-medium mb-2" />
                            <x-text-input id="first_name"
                                class="block w-full px-3 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 bg-pink-50/50"
                                type="text" name="first_name" :value="old('first_name')" required autofocus autocomplete="given-name"
                                placeholder="First name" />
                            <x-input-error :messages="$errors->get('first_name')" class="mt-2 text-rose-600 text-sm" />
                        </div>

                        <!-- Middle Name -->
                        <div>
                            <x-input-label for="middle_name" :value="__('Middle Name')" class="text-neutral-700 font-medium mb-2" />
                            <x-text-input id="middle_name"
                                class="block w-full px-3 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 bg-pink-50/50"
                                type="text" name="middle_name" :value="old('middle_name')" autocomplete="additional-name"
                                placeholder="Middle name (optional)" />
                            <x-input-error :messages="$errors->get('middle_name')" class="mt-2 text-rose-600 text-sm" />
                        </div>

                        <!-- Last Name -->
                        <div>
                            <x-input-label for="last_name" :value="__('Last Name')" class="text-neutral-700 font-medium mb-2" />
                            <x-text-input id="last_name"
                                class="block w-full px-3 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 bg-pink-50/50"
                                type="text" name="last_name" :value="old('last_name')" required autocomplete="family-name"
                                placeholder="Last name" />
                            <x-input-error :messages="$errors->get('last_name')" class="mt-2 text-rose-600 text-sm" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Gender -->
                        <div>
                            <x-input-label for="gender" :value="__('Gender')" class="text-neutral-700 font-medium mb-2" />
                            ...
                            <x-input-error :messages="$errors->get('gender')" class="mt-2 text-rose-600 text-sm" />
                        </div>

                        <!-- Birth Date -->
                        <div>
                            <x-input-label for="birth_date" :value="__('Birth Date')" class="text-neutral-700 font-medium mb-2" />
                            <x-text-input id="birth_date"
                                class="block w-full px-3 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 bg-pink-50/50"
                                type="date" name="birth_date" :value="old('birth_date')" required autocomplete="bday" />
                            <x-input-error :messages="$errors->get('birth_date')" class="mt-2 text-rose-600 text-sm" />
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-pink-100 shadow-sm">
                    ...
                    <!-- Mobile Number -->
                    <div class="mb-4">
                        <x-input-label for="mobile_number" :value="__('Mobile Number')" class="text-neutral-700 font-medium mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                    ...
                    <!-- Address -->
                    <div>
                        <x-input-label for="address" :value="__('Address')" class="text-neutral-700 font-medium mb-2" />
                        <div class="relative">
                            ...
                            <textarea id="address" name="address" required rows="3" autocomplete="street-address"
                                class="block w-full pl-10 pr-3 py-3 border border-pink-200 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-colors duration-200 bg-pink-50/50 resize-none"
                                placeholder="Enter your complete address">{{ old('address') }}</textarea>
                        </div>
                        <x-input-error :messages="$errors->get('address')" class="mt-2 text-rose-600 text-sm" />
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl border border-pink-100 shadow-sm">
                    ...
                    <div>
                        <x-input-label for="password_confirmation" :value="__('Confirm Password')"
                            class="text-neutral-700 font-medium mb-2" />
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button type="button" onclick="togglePassword('password_confirmation')" class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <svg id="password_confirmation-eye" class="h-5 w-5 text-pink-400 hover:text-pink-600 cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </button>
