            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <form method="POST" action="{{ route('admin.users.update', $user) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl">
                        ...
                        <div>
                            ...
                            <textarea id="address" 
                                      ...
                                      required 
                                      rows="3" 
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-pink-500 @error('address') border-red-500 @enderror resize-none">{{ old('address', $user->address) }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="role" 
                                    ...
                                    <option value="aesthetician" {{ old('role', $user->role) === 'aesthetician' ? 'selected' : '' }}>Aesthetician</option>
                            ...
                            <div>
                                ...
                                @if($user->profile_picture)
                                    <div class="mt-2 flex items-center">
                                        ...
                                        <span class="ml-2 text-sm text-gray-600">Current picture</span>
                                    </div>
                                @endif
                        ...
                        <div id="serviceAssignmentSection" class="mt-6 {{ !in_array($user->role, ['nurse', 'aesthetician']) ? 'hidden' : '' }}">
                            ...
                            <div id="nurseServiceSection" class="{{ $user->role === 'nurse' ? '' : 'hidden' }}">
                                ...
                                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                    ...
                                    <p class="text-xs text-green-700 mt-1">This service is automatically assigned to nurses</p>
                                </div>
                            </div>

                            <!-- Aesthetician Service Assignment (Multiple Selection) -->
                            <div id="aestheticianServiceSection" class="{{ $user->role === 'aesthetician' ? '' : 'hidden' }}">
                    ...
                    <div class="flex justify-end space-x-4 pt-6 border-t">
                        ...
                        <x-confirm-button action="update" title="Update User" text="Are you sure you want to update this user account?" class="px-6 py-2 bg-pink-500 hover:bg-pink-600 text-white rounded-lg font-medium">
                            Update User
                        </x-confirm-button>
                    </div>
                </form>
