...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login', [RoleBasedLoginController::class, 'login']);
    ...
    Route::post('resend-verification-code', [RegisteredUserController::class, 'resendVerificationCode'])
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('logout', [RoleBasedLoginController::class, 'logout'])
        ->name('logout');
});
